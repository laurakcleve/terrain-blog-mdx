...
category: 'terrain'
slug: '/terrain/cave-tile-system'
---

import ExtLink from '../../src/images/extLink.svg';
import Important from '../../src/images/important.svg';
...
<div className="note">
  ...
  Since this dungeon set revolves so much around Lost Mines of Phandelver, there
  are pictures below that show some of the later content.
</div>
...
- [Cave tiles](../making-a-cave-tile/) <ExtLink className="ext-link" />
- [Rectangular dungeon tiles](../making-a-dungeon-tile/) <ExtLink className="ext-link" />
- [Water tiles](../making-water-tiles/) <ExtLink className="ext-link" />

And some of the extra pieces here:

- [Stone pillars](../stone-pillars/) <ExtLink className="ext-link" />
- [Waterfall](../waterfall/) <ExtLink className="ext-link" />
- [Small water pool (the water test)](../water-effects-prototype/) <ExtLink className="ext-link" />
...
<h3 className="subheading">Magnets</h3>
